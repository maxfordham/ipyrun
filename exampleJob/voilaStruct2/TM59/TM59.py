...
parameters['fdir_analysis_interim'] = os.path.join(parameters['fdir_interim_data'])
parameters['fdir_graphs_interim'] = os.path.join(parameters['fdir_analysis_interim'], r'graphs')
parameters['fdir_analysis_processed'] = os.path.join(parameters['fdir_processed_data'])
